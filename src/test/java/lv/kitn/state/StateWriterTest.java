...
import static lv.kitn.state.BuildingType.CITY;
import static lv.kitn.state.BuildingType.FARM;
import static lv.kitn.state.BuildingType.MINE;
import static lv.kitn.state.BuildingType.PORT;
import static lv.kitn.state.BuildingType.WOOD;
